...
/**
 * Created by brahmanand.c on 9/11/2017.
 */
public class AttachFileToEntity {
     ...
     * @throws Exception
     */
    protected void attachFileToEntity(final String serverUrl, final String domain,
        ...
        */
        ...
        AttachFileToEntity example = new AttachFileToEntity();
